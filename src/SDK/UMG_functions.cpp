...
// (Final, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct FLinearColor                     InBorderColorAndOpacity                                (Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UTextBlock::SetBorderColorAndOpacity(const struct FLinearColor& InBorderColorAndOpacity)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TextBlock", "SetBorderColorAndOpacity");

	Params::TextBlock_SetBorderColorAndOpacity Parms{};

	Parms.InBorderColorAndOpacity = std::move(InBorderColorAndOpacity);
...
void UTextBlock::SetBorderOpacity(float InOpacity)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TextBlock", "SetBorderOpacity");

	Params::TextBlock_SetBorderOpacity Parms{};
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                                   InCharacterSpacing                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UTextBlock::SetCharacterSpacing(float InCharacterSpacing)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TextBlock", "SetCharacterSpacing");

	Params::TextBlock_SetCharacterSpacing Parms{};
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// struct FMargin                          InMargin                                               (Parm, NoDestructor, NativeAccessSpecifierPublic)

void UTextBlock::SetMargin(const struct FMargin& InMargin)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TextBlock", "SetMargin");

	Params::TextBlock_SetMargin Parms{};
