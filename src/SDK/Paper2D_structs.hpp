...
{
public:
	TSoftObjectPtr<class UPaperSprite>            SpriteRef;                                         // 0x0000(0x0018)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AtlasIndex;                                        // 0x0018(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         X;                                                 // 0x001C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Y;                                                 // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Width;                                             // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Height;                                            // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPaperSpriteAtlasSlot) == 0x000008, "Wrong alignment on FPaperSpriteAtlasSlot");
static_assert(sizeof(FPaperSpriteAtlasSlot) == 0x000030, "Wrong size on FPaperSpriteAtlasSlot");
...
static_assert(offsetof(FPaperSpriteAtlasSlot, AtlasIndex) == 0x000018, "Member 'FPaperSpriteAtlasSlot::AtlasIndex' has a wrong offset!");
static_assert(offsetof(FPaperSpriteAtlasSlot, X) == 0x00001C, "Member 'FPaperSpriteAtlasSlot::X' has a wrong offset!");
static_assert(offsetof(FPaperSpriteAtlasSlot, Y) == 0x000020, "Member 'FPaperSpriteAtlasSlot::Y' has a wrong offset!");
static_assert(offsetof(FPaperSpriteAtlasSlot, Width) == 0x000024, "Member 'FPaperSpriteAtlasSlot::Width' has a wrong offset!");
static_assert(offsetof(FPaperSpriteAtlasSlot, Height) == 0x000028, "Member 'FPaperSpriteAtlasSlot::Height' has a wrong offset!");
