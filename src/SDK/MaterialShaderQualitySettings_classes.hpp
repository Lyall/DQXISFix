...
{
public:
	TMap<class FName, class UShaderPlatformQualitySettings*> ForwardSettingMap;                                 // 0x0038(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMaterialShaderQualitySettings) == 0x000088, "Wrong size on UMaterialShaderQualitySettings");
static_assert(offsetof(UMaterialShaderQualitySettings, ForwardSettingMap) == 0x000038, "Member 'UMaterialShaderQualitySettings::ForwardSettingMap' has a wrong offset!");
...
{
public:
	struct FMaterialQualityOverrides              QualityOverrides[0x3];                             // 0x0038(0x0006)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UShaderPlatformQualitySettings, QualityOverrides) == 0x000038, "Member 'UShaderPlatformQualitySettings::QualityOverrides' has a wrong offset!");
