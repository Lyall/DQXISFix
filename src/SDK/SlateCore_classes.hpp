...
static_assert(sizeof(UFontBulkData) == 0x0000D0, "Wrong size on UFontBulkData");
...
static_assert(sizeof(IFontFaceInterface) == 0x000038, "Wrong size on IFontFaceInterface");
...
static_assert(sizeof(IFontProviderInterface) == 0x000038, "Wrong size on IFontProviderInterface");
...
static_assert(sizeof(USlateTypes) == 0x000038, "Wrong size on USlateTypes");
...
{
public:
	class USlateWidgetStyleContainerBase*         CustomStyle;                                       // 0x0038(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USlateWidgetStyleAsset) == 0x000040, "Wrong size on USlateWidgetStyleAsset");
static_assert(offsetof(USlateWidgetStyleAsset, CustomStyle) == 0x000038, "Member 'USlateWidgetStyleAsset::CustomStyle' has a wrong offset!");
...
static_assert(sizeof(USlateWidgetStyleContainerBase) == 0x000040, "Wrong size on USlateWidgetStyleContainerBase");
...
static_assert(sizeof(ISlateWidgetStyleContainerInterface) == 0x000038, "Wrong size on ISlateWidgetStyleContainerInterface");
