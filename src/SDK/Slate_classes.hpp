...
{
public:
	struct FButtonStyle                           ButtonStyle;                                       // 0x0040(0x0238)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UButtonWidgetStyle) == 0x000278, "Wrong size on UButtonWidgetStyle");
...
{
public:
	struct FCheckBoxStyle                         CheckBoxStyle;                                     // 0x0040(0x04F0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCheckBoxWidgetStyle) == 0x000530, "Wrong size on UCheckBoxWidgetStyle");
...
{
public:
	struct FComboBoxStyle                         ComboBoxStyle;                                     // 0x0040(0x0378)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboBoxWidgetStyle) == 0x0003B8, "Wrong size on UComboBoxWidgetStyle");
...
{
public:
	struct FComboButtonStyle                      ComboButtonStyle;                                  // 0x0040(0x0340)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboButtonWidgetStyle) == 0x000380, "Wrong size on UComboButtonWidgetStyle");
...
{
public:
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0040(0x0728)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextBoxWidgetStyle) == 0x000768, "Wrong size on UEditableTextBoxWidgetStyle");
...
{
public:
	struct FEditableTextStyle                     EditableTextStyle;                                 // 0x0040(0x01F0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextWidgetStyle) == 0x000230, "Wrong size on UEditableTextWidgetStyle");
...
{
public:
	struct FProgressBarStyle                      ProgressBarStyle;                                  // 0x0040(0x0170)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UProgressWidgetStyle) == 0x0001B0, "Wrong size on UProgressWidgetStyle");
...
{
public:
	struct FScrollBarStyle                        ScrollBarStyle;                                    // 0x0040(0x0440)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UScrollBarWidgetStyle) == 0x000480, "Wrong size on UScrollBarWidgetStyle");
...
{
public:
	struct FScrollBoxStyle                        ScrollBoxStyle;                                    // 0x0040(0x01E8)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UScrollBoxWidgetStyle) == 0x000228, "Wrong size on UScrollBoxWidgetStyle");
...
{
public:
	bool                                          bExplicitCanvasChildZOrder;                        // 0x0038(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USlateSettings) == 0x000040, "Wrong size on USlateSettings");
static_assert(offsetof(USlateSettings, bExplicitCanvasChildZOrder) == 0x000038, "Member 'USlateSettings::bExplicitCanvasChildZOrder' has a wrong offset!");
...
{
public:
	struct FSpinBoxStyle                          SpinBoxStyle;                                      // 0x0040(0x0298)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USpinBoxWidgetStyle) == 0x0002D8, "Wrong size on USpinBoxWidgetStyle");
...
{
public:
	struct FTextBlockStyle                        TextBlockStyle;                                    // 0x0040(0x01E0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTextBlockWidgetStyle) == 0x000220, "Wrong size on UTextBlockWidgetStyle");
