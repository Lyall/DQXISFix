...
static_assert(sizeof(UBlueprintGameplayTagLibrary) == 0x000038, "Wrong size on UBlueprintGameplayTagLibrary");
...
static_assert(sizeof(IGameplayTagAssetInterface) == 0x000038, "Wrong size on IGameplayTagAssetInterface");
...
{
public:
	class FString                                 UserDescription;                                   // 0x0038(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_48[0x10];                                      // 0x0048(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UEditableGameplayTagQueryExpression*    RootExpression;                                    // 0x0058(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      TagQueryExportText_Helper;                         // 0x0060(0x0048)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UEditableGameplayTagQuery) == 0x0000A8, "Wrong size on UEditableGameplayTagQuery");
static_assert(offsetof(UEditableGameplayTagQuery, UserDescription) == 0x000038, "Member 'UEditableGameplayTagQuery::UserDescription' has a wrong offset!");
static_assert(offsetof(UEditableGameplayTagQuery, RootExpression) == 0x000058, "Member 'UEditableGameplayTagQuery::RootExpression' has a wrong offset!");
static_assert(offsetof(UEditableGameplayTagQuery, TagQueryExportText_Helper) == 0x000060, "Member 'UEditableGameplayTagQuery::TagQueryExportText_Helper' has a wrong offset!");
...
static_assert(sizeof(UEditableGameplayTagQueryExpression) == 0x000038, "Wrong size on UEditableGameplayTagQueryExpression");
...
static_assert(sizeof(UEditableGameplayTagQueryExpression_AnyTagsMatch) == 0x000058, "Wrong size on UEditableGameplayTagQueryExpression_AnyTagsMatch");
static_assert(offsetof(UEditableGameplayTagQueryExpression_AnyTagsMatch, Tags) == 0x000038, "Member 'UEditableGameplayTagQueryExpression_AnyTagsMatch::Tags' has a wrong offset!");
...
static_assert(sizeof(UEditableGameplayTagQueryExpression_AllTagsMatch) == 0x000058, "Wrong size on UEditableGameplayTagQueryExpression_AllTagsMatch");
static_assert(offsetof(UEditableGameplayTagQueryExpression_AllTagsMatch, Tags) == 0x000038, "Member 'UEditableGameplayTagQueryExpression_AllTagsMatch::Tags' has a wrong offset!");
...
static_assert(sizeof(UEditableGameplayTagQueryExpression_NoTagsMatch) == 0x000058, "Wrong size on UEditableGameplayTagQueryExpression_NoTagsMatch");
static_assert(offsetof(UEditableGameplayTagQueryExpression_NoTagsMatch, Tags) == 0x000038, "Member 'UEditableGameplayTagQueryExpression_NoTagsMatch::Tags' has a wrong offset!");
...
{
public:
	TArray<class UEditableGameplayTagQueryExpression*> Expressions;                                       // 0x0038(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableGameplayTagQueryExpression_AnyExprMatch) == 0x000048, "Wrong size on UEditableGameplayTagQueryExpression_AnyExprMatch");
static_assert(offsetof(UEditableGameplayTagQueryExpression_AnyExprMatch, Expressions) == 0x000038, "Member 'UEditableGameplayTagQueryExpression_AnyExprMatch::Expressions' has a wrong offset!");
...
static_assert(sizeof(UEditableGameplayTagQueryExpression_AllExprMatch) == 0x000048, "Wrong size on UEditableGameplayTagQueryExpression_AllExprMatch");
static_assert(offsetof(UEditableGameplayTagQueryExpression_AllExprMatch, Expressions) == 0x000038, "Member 'UEditableGameplayTagQueryExpression_AllExprMatch::Expressions' has a wrong offset!");
...
static_assert(sizeof(UEditableGameplayTagQueryExpression_NoExprMatch) == 0x000048, "Wrong size on UEditableGameplayTagQueryExpression_NoExprMatch");
static_assert(offsetof(UEditableGameplayTagQueryExpression_NoExprMatch, Expressions) == 0x000038, "Member 'UEditableGameplayTagQueryExpression_NoExprMatch::Expressions' has a wrong offset!");
...
public:
	...
	TArray<struct FGameplayTagSource>             TagSources;                                        // 0x00B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UGameplayTagsManager, TagSources) == 0x0000B8, "Member 'UGameplayTagsManager::TagSources' has a wrong offset!");
...
{
public:
	class FString                                 ConfigFileName;                                    // 0x0038(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayTagsList) == 0x000058, "Wrong size on UGameplayTagsList");
static_assert(offsetof(UGameplayTagsList, ConfigFileName) == 0x000038, "Member 'UGameplayTagsList::ConfigFileName' has a wrong offset!");
static_assert(offsetof(UGameplayTagsList, GameplayTagList) == 0x000048, "Member 'UGameplayTagsList::GameplayTagList' has a wrong offset!");
...
public:
	...
	bool                                          FastReplication;                                   // 0x0070(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGameplayTagsSettings, ImportTagsFromConfig) == 0x000058, "Member 'UGameplayTagsSettings::ImportTagsFromConfig' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, WarnOnInvalidTags) == 0x000059, "Member 'UGameplayTagsSettings::WarnOnInvalidTags' has a wrong offset!");
...
static_assert(offsetof(UGameplayTagsSettings, FastReplication) == 0x000070, "Member 'UGameplayTagsSettings::FastReplication' has a wrong offset!");
