...
static_assert(sizeof(FBoxSphereBounds) == 0x000020, "Wrong size on FBoxSphereBounds");
...
// ScriptStruct CoreUObject.InterpCurvePointVector4
// 0x0050 (0x0050 - 0x0000)
struct FInterpCurvePointVector4 final
{
public:
	float                                         InVal;                                             // 0x0000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0xC];                                        // 0x0004(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector4                               OutVal;                                            // 0x0010(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector4                               ArriveTangent;                                     // 0x0020(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector4                               LeaveTangent;                                      // 0x0030(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EInterpCurveMode                              InterpMode;                                        // 0x0040(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_41[0xF];                                       // 0x0041(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FInterpCurvePointVector4) == 0x000010, "Wrong alignment on FInterpCurvePointVector4");
static_assert(sizeof(FInterpCurvePointVector4) == 0x000050, "Wrong size on FInterpCurvePointVector4");
static_assert(offsetof(FInterpCurvePointVector4, InVal) == 0x000000, "Member 'FInterpCurvePointVector4::InVal' has a wrong offset!");
static_assert(offsetof(FInterpCurvePointVector4, OutVal) == 0x000010, "Member 'FInterpCurvePointVector4::OutVal' has a wrong offset!");
static_assert(offsetof(FInterpCurvePointVector4, ArriveTangent) == 0x000020, "Member 'FInterpCurvePointVector4::ArriveTangent' has a wrong offset!");
static_assert(offsetof(FInterpCurvePointVector4, LeaveTangent) == 0x000030, "Member 'FInterpCurvePointVector4::LeaveTangent' has a wrong offset!");
static_assert(offsetof(FInterpCurvePointVector4, InterpMode) == 0x000040, "Member 'FInterpCurvePointVector4::InterpMode' has a wrong offset!");

// ScriptStruct CoreUObject.InterpCurveVector4
// 0x0018 (0x0018 - 0x0000)
struct FInterpCurveVector4 final
{
public:
	TArray<struct FInterpCurvePointVector4>       Points;                                            // 0x0000(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bIsLooped;                                         // 0x0010(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         LoopKeyOffset;                                     // 0x0014(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FInterpCurveVector4) == 0x000008, "Wrong alignment on FInterpCurveVector4");
static_assert(sizeof(FInterpCurveVector4) == 0x000018, "Wrong size on FInterpCurveVector4");
static_assert(offsetof(FInterpCurveVector4, Points) == 0x000000, "Member 'FInterpCurveVector4::Points' has a wrong offset!");
static_assert(offsetof(FInterpCurveVector4, bIsLooped) == 0x000010, "Member 'FInterpCurveVector4::bIsLooped' has a wrong offset!");
static_assert(offsetof(FInterpCurveVector4, LoopKeyOffset) == 0x000014, "Member 'FInterpCurveVector4::LoopKeyOffset' has a wrong offset!");
...
static_assert(sizeof(FSoftClassPath) == 0x000008, "Wrong size on FSoftClassPath");
