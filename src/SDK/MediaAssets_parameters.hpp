...
struct MediaPlayer_SelectSubTrack final
{
public:
...
static_assert(alignof(MediaPlayer_SelectSubTrack) == 0x000004, "Wrong alignment on MediaPlayer_SelectSubTrack");
static_assert(sizeof(MediaPlayer_SelectSubTrack) == 0x00000C, "Wrong size on MediaPlayer_SelectSubTrack");
static_assert(offsetof(MediaPlayer_SelectSubTrack, TrackType) == 0x000000, "Member 'MediaPlayer_SelectSubTrack::TrackType' has a wrong offset!");
static_assert(offsetof(MediaPlayer_SelectSubTrack, TrackIndex) == 0x000004, "Member 'MediaPlayer_SelectSubTrack::TrackIndex' has a wrong offset!");
static_assert(offsetof(MediaPlayer_SelectSubTrack, ReturnValue) == 0x000008, "Member 'MediaPlayer_SelectSubTrack::ReturnValue' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct MediaPlayer_StartPreDecoding final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MediaPlayer_StartPreDecoding) == 0x000001, "Wrong alignment on MediaPlayer_StartPreDecoding");
static_assert(sizeof(MediaPlayer_StartPreDecoding) == 0x000001, "Wrong size on MediaPlayer_StartPreDecoding");
static_assert(offsetof(MediaPlayer_StartPreDecoding, ReturnValue) == 0x000000, "Member 'MediaPlayer_StartPreDecoding::ReturnValue' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct MediaPlayer_IsPreDecodingCompleted final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MediaPlayer_IsPreDecodingCompleted) == 0x000001, "Wrong alignment on MediaPlayer_IsPreDecodingCompleted");
static_assert(sizeof(MediaPlayer_IsPreDecodingCompleted) == 0x000001, "Wrong size on MediaPlayer_IsPreDecodingCompleted");
static_assert(offsetof(MediaPlayer_IsPreDecodingCompleted, ReturnValue) == 0x000000, "Member 'MediaPlayer_IsPreDecodingCompleted::ReturnValue' has a wrong offset!");
