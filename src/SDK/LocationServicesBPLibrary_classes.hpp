...
static_assert(sizeof(ULocationServices) == 0x000038, "Wrong size on ULocationServices");
...
{
public:
	UMulticastDelegateProperty_                   OnLocationChanged;                                 // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULocationServicesImpl) == 0x000048, "Wrong size on ULocationServicesImpl");
static_assert(offsetof(ULocationServicesImpl, OnLocationChanged) == 0x000038, "Member 'ULocationServicesImpl::OnLocationChanged' has a wrong offset!");
