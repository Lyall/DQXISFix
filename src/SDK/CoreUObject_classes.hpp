...
static_assert(sizeof(UObject) == 0x000038, "Wrong size on UObject");
...
{
public:
	class UField*                                 Next;                                              // 0x0038(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UField) == 0x000040, "Wrong size on UField");
static_assert(offsetof(UField, Next) == 0x000038, "Member 'UField::Next' has a wrong offset!");
...
static_assert(offsetof(UClass, CastFlags) == 0x0000C8, "Member 'UClass::CastFlags' has a wrong offset!");
...
{
public:
	uint8                                         Pad_230[0x1A0];                                    // 0x0230(0x01A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPackage) == 0x000170, "Wrong size on UPackage");
...
static_assert(sizeof(IInterface) == 0x000038, "Wrong size on IInterface");
...
static_assert(sizeof(UTextBuffer) == 0x000060, "Wrong size on UTextBuffer");
...
public:
	...
	class TArray<class TPair<class FName, int64>> Names;                                             // 0x0050(0x0010)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UEnum) == 0x000070, "Wrong size on UEnum");
static_assert(offsetof(UEnum, Names) == 0x000050, "Member 'UEnum::Names' has a wrong offset!");
...
public:
	...
	int32                                         ElementSize;                                       // 0x0044(0x0004)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(offsetof(UProperty, ArrayDim) == 0x000040, "Member 'UProperty::ArrayDim' has a wrong offset!");
static_assert(offsetof(UProperty, ElementSize) == 0x000044, "Member 'UProperty::ElementSize' has a wrong offset!");
static_assert(offsetof(UProperty, PropertyFlags) == 0x000048, "Member 'UProperty::PropertyFlags' has a wrong offset!");
static_assert(offsetof(UProperty, Offset) == 0x000054, "Member 'UProperty::Offset' has a wrong offset!");
...
static_assert(sizeof(ULinkerPlaceholderExportObject) == 0x0000E8, "Wrong size on ULinkerPlaceholderExportObject");
...
{
public:
	uint8                                         Pad_C8[0x1A0];                                     // 0x00C8(0x01A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULinkerPlaceholderFunction) == 0x000268, "Wrong size on ULinkerPlaceholderFunction");
...
static_assert(sizeof(UMetaData) == 0x0000D8, "Wrong size on UMetaData");
...
static_assert(sizeof(UObjectRedirector) == 0x000040, "Wrong size on UObjectRedirector");
...
static_assert(sizeof(UMapProperty) == 0x0000B8, "Wrong size on UMapProperty");
...
static_assert(sizeof(USetProperty) == 0x0000A8, "Wrong size on USetProperty");
