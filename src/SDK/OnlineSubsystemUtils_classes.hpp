...
static_assert(sizeof(UAchievementBlueprintLibrary) == 0x000038, "Wrong size on UAchievementBlueprintLibrary");
...
{
public:
	uint8                                         Pad_33670[0x20];                                   // 0x33670(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x033690, "Wrong size on UIpConnection");
...
static_assert(sizeof(UConnectionCallbackProxy) == 0x0000B0, "Wrong size on UConnectionCallbackProxy");
...
static_assert(sizeof(UCreateSessionCallbackProxy) == 0x000100, "Wrong size on UCreateSessionCallbackProxy");
...
static_assert(sizeof(UDestroySessionCallbackProxy) == 0x0000B0, "Wrong size on UDestroySessionCallbackProxy");
...
static_assert(sizeof(UFindSessionsCallbackProxy) == 0x0000D0, "Wrong size on UFindSessionsCallbackProxy");
...
static_assert(offsetof(UInAppPurchaseCallbackProxy, OnSuccess) == 0x000038, "Member 'UInAppPurchaseCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(UInAppPurchaseCallbackProxy, OnFailure) == 0x000048, "Member 'UInAppPurchaseCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(offsetof(UInAppPurchaseQueryCallbackProxy, OnSuccess) == 0x000038, "Member 'UInAppPurchaseQueryCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(UInAppPurchaseQueryCallbackProxy, OnFailure) == 0x000048, "Member 'UInAppPurchaseQueryCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(offsetof(UInAppPurchaseRestoreCallbackProxy, OnSuccess) == 0x000038, "Member 'UInAppPurchaseRestoreCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(UInAppPurchaseRestoreCallbackProxy, OnFailure) == 0x000048, "Member 'UInAppPurchaseRestoreCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(ULeaderboardBlueprintLibrary) == 0x000038, "Wrong size on ULeaderboardBlueprintLibrary");
...
static_assert(offsetof(ULeaderboardFlushCallbackProxy, OnSuccess) == 0x000038, "Member 'ULeaderboardFlushCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(ULeaderboardFlushCallbackProxy, OnFailure) == 0x000048, "Member 'ULeaderboardFlushCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(offsetof(ULeaderboardQueryCallbackProxy, OnSuccess) == 0x000038, "Member 'ULeaderboardQueryCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(ULeaderboardQueryCallbackProxy, OnFailure) == 0x000048, "Member 'ULeaderboardQueryCallbackProxy::OnFailure' has a wrong offset!");
...
public:
	...
	float                                         BeaconConnectionInitialTimeout;                    // 0x03A0(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         BeaconConnectionTimeout;                           // 0x03A4(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNetDriver*                             NetDriver;                                         // 0x03A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AOnlineBeacon) == 0x0003C0, "Wrong size on AOnlineBeacon");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionInitialTimeout) == 0x0003A0, "Member 'AOnlineBeacon::BeaconConnectionInitialTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionTimeout) == 0x0003A4, "Member 'AOnlineBeacon::BeaconConnectionTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, NetDriver) == 0x0003A8, "Member 'AOnlineBeacon::NetDriver' has a wrong offset!");
...
{
public:
	class AOnlineBeaconHostObject*                BeaconOwner;                                       // 0x03C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNetConnection*                         BeaconConnection;                                  // 0x03C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_3D1[0x6F];                                     // 0x03D1(0x006F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AOnlineBeaconClient) == 0x000440, "Wrong size on AOnlineBeaconClient");
static_assert(offsetof(AOnlineBeaconClient, BeaconOwner) == 0x0003C0, "Member 'AOnlineBeaconClient::BeaconOwner' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, BeaconConnection) == 0x0003C8, "Member 'AOnlineBeaconClient::BeaconConnection' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, ConnectionState) == 0x0003D0, "Member 'AOnlineBeaconClient::ConnectionState' has a wrong offset!");
...
public:
	...
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x03C8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AOnlineBeaconHost) == 0x000478, "Wrong size on AOnlineBeaconHost");
static_assert(offsetof(AOnlineBeaconHost, ListenPort) == 0x0003C0, "Member 'AOnlineBeaconHost::ListenPort' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, ClientActors) == 0x0003C8, "Member 'AOnlineBeaconHost::ClientActors' has a wrong offset!");
...
{
public:
	class FString                                 BeaconTypeName;                                    // 0x0398(0x0010)(ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class AOnlineBeaconClient>        ClientBeaconActorClass;                            // 0x03A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x03B0(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AOnlineBeaconHostObject) == 0x0003C0, "Wrong size on AOnlineBeaconHostObject");
static_assert(offsetof(AOnlineBeaconHostObject, BeaconTypeName) == 0x000398, "Member 'AOnlineBeaconHostObject::BeaconTypeName' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientBeaconActorClass) == 0x0003A8, "Member 'AOnlineBeaconHostObject::ClientBeaconActorClass' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientActors) == 0x0003B0, "Member 'AOnlineBeaconHostObject::ClientActors' has a wrong offset!");
...
{
public:
	class FName                                   VoiceSubsystemNameOverride;                        // 0x0038(0x0008)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UOnlineEngineInterfaceImpl) == 0x000140, "Wrong size on UOnlineEngineInterfaceImpl");
static_assert(offsetof(UOnlineEngineInterfaceImpl, VoiceSubsystemNameOverride) == 0x000038, "Member 'UOnlineEngineInterfaceImpl::VoiceSubsystemNameOverride' has a wrong offset!");
...
{
public:
	uint8                                         Pad_38[0x288];                                     // 0x0038(0x0288)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_440[0xC0];                                     // 0x0440(0x00C0)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	class UPartyBeaconState*                      State;                                             // 0x03C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3C8[0x148];                                    // 0x03C8(0x0148)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(APartyBeaconHost, State) == 0x0003C0, "Member 'APartyBeaconHost::State' has a wrong offset!");
...
{
public:
	class FName                                   SessionName;                                       // 0x0038(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         NumConsumedReservations;                           // 0x0040(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         MaxReservations;                                   // 0x0044(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         NumTeams;                                          // 0x0048(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         NumPlayersPerTeam;                                 // 0x004C(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   TeamAssignmentMethod;                              // 0x0050(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UPartyBeaconState) == 0x000080, "Wrong size on UPartyBeaconState");
static_assert(offsetof(UPartyBeaconState, SessionName) == 0x000038, "Member 'UPartyBeaconState::SessionName' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, NumConsumedReservations) == 0x000040, "Member 'UPartyBeaconState::NumConsumedReservations' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, MaxReservations) == 0x000044, "Member 'UPartyBeaconState::MaxReservations' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, NumTeams) == 0x000048, "Member 'UPartyBeaconState::NumTeams' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, NumPlayersPerTeam) == 0x00004C, "Member 'UPartyBeaconState::NumPlayersPerTeam' has a wrong offset!");
static_assert(offsetof(UPartyBeaconState, TeamAssignmentMethod) == 0x000050, "Member 'UPartyBeaconState::TeamAssignmentMethod' has a wrong offset!");
...
static_assert(offsetof(UPartyBeaconState, Reservations) == 0x000060, "Member 'UPartyBeaconState::Reservations' has a wrong offset!");
...
static_assert(sizeof(ATestBeaconHost) == 0x0003C0, "Wrong size on ATestBeaconHost");
...
static_assert(sizeof(UTurnBasedBlueprintLibrary) == 0x000038, "Wrong size on UTurnBasedBlueprintLibrary");
