...
static_assert(sizeof(UMobileInstalledContent) == 0x000058, "Wrong size on UMobileInstalledContent");
...
static_assert(sizeof(UMobilePendingContent) == 0x000098, "Wrong size on UMobilePendingContent");
...
static_assert(sizeof(UMobilePatchingLibrary) == 0x000038, "Wrong size on UMobilePatchingLibrary");
