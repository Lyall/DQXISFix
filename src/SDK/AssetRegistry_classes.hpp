...
{
public:
	uint8                                         Pad_38[0xCD8];                                     // 0x0038(0x0CD8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x000D10, "Wrong size on UAssetRegistryImpl");
...
static_assert(sizeof(UAssetRegistryHelpers) == 0x000038, "Wrong size on UAssetRegistryHelpers");
...
static_assert(sizeof(IAssetRegistry) == 0x000038, "Wrong size on IAssetRegistry");
